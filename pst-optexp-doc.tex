...
\end{pspicture}
\end{LTXexample}
\caption{Code example on how to use the \parameter{conn} in experimental setups.\label{lst:conn}}
\end{LTXexampleFloat}
...
\section{Complete List of Parameters and Styles}
\begin{longtable}{BTT}
...
\begin{table}[H]
\addtolength{\extrarowheight}{1.5mm}
\begin{tabularx}{0.85\linewidth}{BX}
...
\bottomrule
\end{tabularx}
\caption{All defined psstyles and their description.}
\end{table}
