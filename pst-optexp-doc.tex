...
\optitem{lensradius}{\prm{num}} A convenience option to specify both curvatures.
...
\begin{optionlist}
\optitem[\opt{parallel}]{poltype}{\opt{parallel}, \opt{perp}, \opt{misc}, \opt{lcirc}, \opt{rcirc}}
...
\optitem[\opt{normal}]{mirrortype}{\opt{normal}, \opt{piezo}, \opt{extended}}
