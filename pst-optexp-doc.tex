...
\begin{pspicture}(0.5,4)(13.2,10.5)
  ...
  \optbox[endbox, fiber, labeloffset=0](12,10)(12.1,10){RX}
  % loop
...
\bottomrule\endfoot
angle & \paramvalue{<value>} & 0 \\
optional & \paramvalue{<boolean>} & false \\
position & \paramvalue{<value>} & \cs{@empty} \\
abspos & \paramvalue{<value>} & \cs{@empty} \\
showoptdots & \paramvalue{<boolean>} & false \\
fiber & \paramvalue{<boolean>} & false\\
extnode & \paramvalue{<ref string>} & \cs{@empty} \\
extnodename & \paramvalue{<string>} & Ext \\
\midrule
lensheight & \paramvalue{<value>} & 1 \\
lenswidth & \paramvalue{<value>} & 0.3 \\
lensradius & \paramvalue{<value> [<value>]} & \cs{@empty} \\
lensradiusleft & \paramvalue{<value>} & 1 \\
lensradiusright & \paramvalue{<value>} & 1 \\
lens & \paramvalue{<value> [<value> [<value> [<value>]]]} & \cs{@empty} \\
thicklens & \paramvalue{<boolean>}& false \\
\midrule
plateheight & \paramvalue{<value>} & 1 \\
platelinewidth & \paramvalue{<value>} & 2\cs{pslinewidth} \\
\midrule
plateheight & \paramvalue{<value>} & 1 \\
platewidth & \paramvalue{<value>} & 0.1 \\
outerheight & \paramvalue{<value>} & 1 \\
innerheight & \paramvalue{<value>} & 0.1 \\
phlinewidth &  \paramvalue{<value>} & 2\cs{pslinewidth} \\
\midrule
crystalwidth & \paramvalue{<value>} & 2 \\
crystalheight & \paramvalue{<value>} & 0.8 \\
caxislength & \paramvalue{<value>} & 0.6 \\
caxisinv & \paramvalue{<boolean>} & false \\
voltage & \paramvalue{<boolean>} & false \\
lamp & \paramvalue{<boolean>} & false \\
lampscale & \paramvalue{<value>} & 0.3 \\
\midrule
optboxheight & \paramvalue{<value>} & 0.5 \\
optboxwidth & \paramvalue{<value>} & 1 \\
endbox & \paramvalue{<boolean>} & false \\
\midrule
detsize & \paramvalue{<value>} & 0.5 \\
\midrule
poltype & \paramvalue{parallel|perp|misc|lcirc|rcirc} & parallel \\
polsize & \paramvalue{<value>} & 0.6 \\
pollinewidth & \paramvalue{<value>} & 0.7\cs{pslinewidth} \\
\midrule
mirrorwidth & \paramvalue{<value>} & 1 \\
mirrorradius & \paramvalue{<value>} & 0 \\
mirrorlinewidth & \paramvalue{<value>} & 2\cs{pslinewidth} \\
mirrortype & \paramvalue{normal|piezo|extended} & normal \\
mirrordepth & \paramvalue{<value>} & 0.08 \\
variable & \paramvalue{<value>} & false \\
\midrule
bssize & \paramvalue{<value>} & 0.8 \\
\midrule
optgridcount & \paramvalue{<integer>} & 10 \\
optgridwidth & \paramvalue{<value>} & 1 \\
optgridheight & \paramvalue{<value>} & 0.1 \\
optgriddepth & \paramvalue{<value>} & 0.05 \\
optgridtype & \paramvalue{blazed|binary} & blazed \\
optgridlinewidth & \paramvalue{<value>} & 0.7\cs{pslinewidth} \\
reverse & \paramvalue{<boolean>} & false \\
\midrule
fiberloops & \paramvalue{<integer>} & 3 \\
fiberloopradius & \paramvalue{<value>} & 0.3 \\
fiberloopsep & \paramvalue{<value>} & 0.3 \\
\midrule
optampsize & \paramvalue{<value>} & 0.8 \\
\midrule
optmzmsize & \paramvalue{<value>} & 0.8 \\
\midrule
filtertype & \paramvalue{bandpass|bandstop} & bandpass \\
\midrule
polcontrolsize & \paramvalue{<value>} & 0.1 \\
\midrule
switchsize & \paramvalue{<value>} & 0.8 \\
switchstyle & \paramvalue{opened|closed} & opened \\
\midrule
couplersize & \paramvalue{<value>} & 0.1 \\
couplersep & \paramvalue{<value>} & 0.1 \\
couplertype & \paramvalue{none|elliptic} & elliptic \\
\midrule
usefiberstyle & \paramvalue{<boolean>} & true \\
Fiber & \paramvalue{<psstyle>} & linecolor=red \\
FiberIn & \paramvalue{<psstyle>} & style=Fiber \\
FiberIn1 & \paramvalue{<psstyle>} & style=FiberIn \\
FiberIn2 & \paramvalue{<psstyle>} & style=FiberIn \\
FiberOut & \paramvalue{<psstyle>} & style=Fiber \\
FiberOut1 & \paramvalue{<psstyle>} & style=FiberOut \\
FiberOut2 & \paramvalue{<psstyle>} & style=FiberOut \\
\midrule
labeloffset & \paramvalue{<value>} & 1 \\
labelangle & \paramvalue{<value>} & 0 \\
labelstyle & \paramvalue{<macro>} & \cs{small} \\
labelalign & \paramvalue{<\cs{rput} ref string>} & c \\
labelref & \paramvalue{relative|relgrav|global} & relgrav \\
\end{longtable}
\newpage
\section{Todo}
