...
of \parameter{c}, \parameter{t}, \parameter{b}, \parameter{l}
and \parameter{r} (compare with \parameter{extnode} in
...
Together with the parameter \parameter{refractiveindex} this can be
exploited to sketch the refraction through a tilted homogeneous medium.
...
\noindent The parameter \texttt{mirrorradius} defines the curvature of the mirror. A
