...
define lens using only \Lkeyword{lensheight} and \Lkeyword{lenswidth}. To use
this old behaviour, you have to set the \Lkeyword{lenstype} explicitly, but
...
\begin{pspicture}[showgrid=true](3,2)
   ...
   \Drawbeam[beamIn=false,linecolor=red]{(0,1)}{1}{(3,1)}.
\end{pspicture}
\end{LTXexample}
