...
\def\pst@draw@component#1#2{%
    %
    \pst@Verb{/@@x 0 def /@@y 0 def /@@x0 0 def /@@y0 0 def}%
    %
    \def\@@comp{%
       #2
...
\def\optbox@iii{%
   ...
   \else
      \ifPst@optexp@fiber
         \pnode(! @@x neg 0){tempNode@A@}
         \pnode(!@@x 0){tempNode@B@}
      \fi
...
\def\optisolator@iii{%
   ...
   \pnode(! \@wd neg 0){tempNode@A@}
   \pnode(! \@wd 0){tempNode@B@}
\ignorespaces}%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
