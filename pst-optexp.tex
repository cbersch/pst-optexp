...
\def\custombeam@i#1{%
   ...
   \def\drawbeam{\def\drawextendedbeam{\errmessage{pst-optexp error: You can't switch from single to extended beam in custom mode}}\@drawbeam}%
   \let\@drawextendedbeam\drawextendedbeam
   \def\drawextendedbeam{\def\drawbeam{\errmessage{pst-optexp error: You can't switch from extended to single beam in custom mode}}\@drawextendedbeam}%
   #1%
   \end@SpecialObj%
   \fi
\ignorespaces}%
...
\def\drawextendedbeam{\pst@object{drawextendedbeam}}%
\def\drawextendedbeam@i{%
  \addbefore@par{n=0}%
  \addafter@par{style=Beam}%
  \begin@DrawbeamObj
  \optexp@getcomps[\drawextendedbeam@ii%
}%
\def\end@DrawbeamObj{%
  \addto@pscode{ end}%
