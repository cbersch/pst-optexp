...
% maintained for backward compatibilyt %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\ifPOE@compat
%
...
\def\newOptexpPlane(#1)(#2)#3{%
    ...
    \pst@Verb{\pst@optexpdict [ {\pst@tempOrig} {\pst@tempDiff} trans {NewPlaneInt} 1 (\POS@optexp@basicname@prefix#3) {} false NewOptexpComp end}%
}%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% END %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
