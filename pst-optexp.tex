...
\def\mirror@comp{%
  ...
  \ifdim\psk@oe@mirrorradius pt<0pt
    \ifx\psk@oe@mirrortype\pst@str@mirrortype@extended
      ...
      \bgroup
        ...
        \begin@ClosedObj
          \addto@pscode{%
            \pst@optexpdict \@mirror@ht \@mirror@r rightConcave \@mirror@postcode  
  ...
  \else\ifdim\psk@oe@mirrorradius pt>0pt
    \ifx\psk@oe@mirrortype\pst@str@mirrortype@extended
      ...
      \bgroup
        ...
        \begin@ClosedObj
          \addto@pscode{%
            \pst@optexpdict \@mirror@ht \@mirror@r rightConvex \@mirror@postcode
  ...
  \else
    ...
    \ifPst@oe@variable
      \psarc[style=VariableMirror](! \@m@wd 0.4 sub 0){0.6}{-20}{20}
      \psarc[style=VariableMirror](! \@m@wd 0.4 sub neg 0){0.6}{160}{200}
     \fi%
     % 
     % mirrortype
