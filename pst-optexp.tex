...
\def\drawfiber@i#1#2{%
  ...
  \begingroup
    ...
    \use@par
    \def\oe@tempa{#1}
    \message{^^J first arg is -#1-^^J}
    \ifx\oe@tempa\@empty
      \message{^^Jfirst is empty}
      \edef\optexp@comps{/\getLastCompname@i\space}
      \message{done}
    \else
      \expandafter\optexp@getnode#1\@nil
      \message{^^Jfirst is  --\oe@temp--^^J}
      \message{blubb}
...
%  \edef\poe@tmp{\the\poe@cnt}% I don't know how to do it with expansion
  ...
  \else
    \ifPOE@endbox
      \ifPOE@fiberin@
        \drawfiber[style=FiberIn]{(\optexp@nodeA)}{(\POK@basicname 1)}
      \fi
    \else
      \ifPOE@fiberin@
        \drawfiber[style=FiberIn]{(\optexp@nodeA)}{(\POK@basicname 1)}
              \fi
      \ifPOE@fiberout@
        \drawfiber[style=FiberOut1]{(\POK@basicname N)}{(\optexp@nodeB)}
      \fi
    \fi
  \fi
}%
   ...
   \@ifundefined{#2@i}{%
      ...
      \expandafter\def\csname #2@i\endcsname(##1)(##2)(##3)(##4)##5{%
         ...
         \begin@OptexpObj
            ...
            % connect the fibers
            \ifPOE@fiberin@top
              \drawfiber[style=FiberIn1]{(##1)}{\POK@compname}
            \fi
            \ifPOE@fiberin@bottom
              \drawfiber[style=FiberIn2]{(##2)}{\POK@compname}
            \fi
            \ifPOE@fiberout@top
              \drawfiber[style=FiberOut1]{\POK@compname}{(##3)}
            \fi
            \ifPOE@fiberout@bottom
              \drawfiber[style=FiberOut2]{\POK@compname}{(##4)}
            \fi
         \end@OptexpObj
      }%
      \@namedef{#2@ii}{%
...
\def\wdmsplitter@i(#1)(#2)(#3)#4{%
   ...
   \begin@OptexpObj
      ...
      % connect the fibers
      \ifPOE@fiberin@
        \drawfiber[style=FiberIn]{(#1)}{\POK@compname}
      \fi
      \ifPOE@fiberout@top
        \drawfiber[style=FiberOut1]{\POK@compname}{(#2)}
      \fi
      \ifPOE@fiberout@bottom
        \drawfiber[style=FiberOut2]{\POK@compname}{(#3)}
      \fi
   \end@OptexpObj
}%
%
...
\def\wdmcoupler@i(#1)(#2)(#3)#4{%
   ...
   \begin@OptexpObj
      ...
      % connect the fibers
      \ifPOE@fiberout@
        \drawfiber[style=FiberOut]{\POK@compname}{(#3)}
      \fi
      \ifPOE@fiberin@top
        \drawfiber[style=FiberIn1]{(#1)}{\POK@compname}
      \fi
