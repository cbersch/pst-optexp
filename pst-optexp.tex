...
\def\Drawfiber@i#1#2{%
  ...
  \pnode(! \optexp@comps \pst@optexpdict NearestNode end \tx@UserCoor 2 copy == ==){OE@@F1}
  \pnode(! \optexp@comps exch \pst@optexpdict NearestNode end \tx@UserCoor 2 copy == ==){OE@@F2}
  \psdot(OE@@F1)
  \psdot[linecolor=red](OE@@F2)
  \nccurve[style=Fiber]{OE@@F1}{OE@@F2}
}%
\def\Drawfiber@ii{%
  \addto@pscode{ {/nMul \POK@refractiveindex@mul\space def} }%
  \ifx\POK@beam@startpos\@empty
