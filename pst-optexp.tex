...
%    \let\psk@angleB\relax
    ...
    \ifx\relax\psk@angleA
      ...
      \psset{angleA=! \pst@optexpdict \optexp@comps exch RelFiberAngleA end}%
    \else
      \ifPOE@relangle
        \psset{angleA=! \pst@optexpdict \optexp@comps exch RelFiberAngleA end \psk@angleA\space add}%
    \fi\fi
    % \ifx\psk@angleB\relax
    %   \psset{angleB=! \pst@optexpdict \optexp@comps exch RelFiberAngleB end}%
    % \else
    %   \ifPOE@relangle
    %     \psset{angleB=! \pst@optexpdict \optexp@comps exch RelFiberAngleB end \psk@angleB\space add}%
    % \fi\fi
...
%  \edef\poe@tmp{\the\poe@cnt}% I don't know how to do it with expansion
  ...
  \else
    \ifPOE@endbox
      \ifPOE@fiberin@
        \drawfiber@{FiberIn}{(\optexp@nodeA)}{(\POK@basicname 1)}
      \fi
    \else
      \ifPOE@fiberin@
        \drawfiber@{FiberIn}{(\optexp@nodeA)}{(\POK@basicname 1)}
              \fi
      \ifPOE@fiberout@
        \drawfiber@{FiberOut1}{(\POK@basicname N)}{(\optexp@nodeB)}
      \fi
    \fi
  \fi
}%
