...
%
% General
\define@boolkey[psset]{optexp}[POE@]{firstrun}[true]{}
\define@boolkey[psset]{optexp}[POE@]{secondrun}[true]{}
...
\def\mirror@iii{%
   ...
   %
   \newOptexpComp%[\ifdim\POK@mirrorradius pt >0pt /useSecond true def \fi]%
                 {{ 0 0 } 
...
%
  \edef\@pol@size{\POK@polsize\space 2 div\space}%
...
\def\optdetector@iii{%
   ...
   \ifx\POK@dettype\POS@dettype@round
      \pnode(! \POK@detsize\space .2 mul 0){\optexp@nodeLabel}%
      \begin@ClosedObj
