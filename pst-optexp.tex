...
\def\custombeam@i#1{%
  ...
  \begin@SpecialObj%
    ...
    \def\drawbeam{%
      ...
      \def\drawextendedbeam{%
        \errmessage{pst-optexp error: You can't switch from single to extended beam in custom mode}%
      }%
      \@drawbeam
    }%
    \let\@drawextendedbeam\drawextendedbeam
    \def\drawextendedbeam{%
      \let\@strokebeam\@strokeextendedbeam
      \def\drawbeam{%
        \errmessage{pst-optexp error: You can't switch from extended to single beam in custom mode}%
      }%
      \@drawextendedbeam
    }%
    \def\begin@ExtendedBeamObj{%
      \begin@BeamObj
      \def\@strokebeam{\addto@pscode{ rearrangeExtBeamPoints }}%
    }%
...
\def\drawextendedbeam@ii{%
  ...
  \else
    ...
    \fi
    \addto@pscode{ TraceExtendedBeam }%
    \@strokebeam
  \fi
  \end@BeamObj
}%
