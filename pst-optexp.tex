...
\def\optbox@comp{%
  ...
  \ifPst@oe@endbox
    \psrotate(! \@wd dup \psk@oe@rotate@xref\space mul add
                \@ht \psk@oe@rotate@yref\space mul){\psk@oe@angle}{%
...
\def\optplate@comp{%
   \psline[linewidth=\psk@oe@platelinewidth]%
          (! \psk@oe@plateheight\space 0.5 mul \psk@oe@angle\space 2 copy sin mul 3 1 roll cos mul neg)%
          (! \psk@oe@plateheight\space 0.5 mul \psk@oe@angle\space 2 copy sin mul neg 3 1 roll cos mul )%
\ignorespaces}%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
\def\optdetector@nodes{%
  ...
  \else\ifx\psk@oe@dettype\pst@str@dettype@diode
    ...
    \pst@OptexpVerb{\psk@oe@detsize\space 0.5 mul dup dup /@@x0 ED /@@x ED /@@y ED}%
  \fi\fi
}%
...
\def\optmzm@nodes{%
  ...
  \pnode(! \@oedict{@@x neg 0}){\oenodein{}}
  \pnode(! \@oedict{@@x 0}){\oenodeout{}}
}%
\def\optmzm@comp{%
...
\def\optisolator@nodes{%
  \pst@OptexpVerb{%
    /@@y \psk@oe@isolatorsize\space 0.5 mul def
    /@@x \psk@oe@isolatorsize\space 0.8 mul def
  }%
  \pnode(! \@oedict{@@x neg 0}){\oenodein{}}
  \pnode(! \@oedict{@@x 0}){\oenodeout{}}
}%
...
\def\optfiberpolarizer@nodes{%
  \pst@OptexpVerb{%
    /@@y \psk@oe@fiberpolsize\space 0.5 mul def
    /@@x \psk@oe@fiberpolsize\space 0.8 mul def
  }%
  \pnode(! \@oedict{@@x neg 0}){\oenodein{}}
  \pnode(! \@oedict{@@x 0}){\oenodeout{}}
}%
