...
%
\edef\POS@filtertype@bandpass{bandpass}
\edef\POS@filtertype@bandstop{bandstop}
%
\edef\POS@couplertype@none{none}
\edef\POS@couplertype@elliptic{elliptic}
\edef\POS@couplertype@crossswitch{crossswitch}
%
\edef\POS@top{top}
\edef\POS@bottom{bottom}
\edef\POS@center{center}
\edef\POS@closed{closed}
\edef\POS@opened{opened}
\edef\POS@basicname@default{@}
\edef\POS@basicname@prefix{OE@}
\edef\POS@extnode@postfix{Ext}
\edef\POS@dettype@round{round}
\edef\POS@dettype@diode{diode}
\edef\POS@bsstyle@cube{cube}
\edef\POS@bsstyle@plate{plate}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% psstyles
%
