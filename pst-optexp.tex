...
\newif\ifPOE@connjoin
\newif\ifPOE@fiber@
\newif\ifPOE@beam@startIn
\newif\ifPOE@beam@stopIn
\newif\ifPOE@beam@beamIn
...
%
% Crossswitch
%\define@key[psset]{optexp}{crossswitchheight}{\edef\POK@crossswitch@height{#1}}
%\define@key[psset]{optexp}{crossswitchwidth}{\edef\POK@crossswitch@width{#1}}
%\define@key[psset]{optexp}{crossswitchsep}{\edef\POK@crossswitch@sep{#1}}
%
%
...
\define@key[psset]{optexp}{@compname}{%
   ...
   \else
      ...
      \else
         ...
         \xdef\POE@complist{#1\ifx\POE@complist\@empty\else,\fi\POE@complist}%
      \fi
   \fi
...
\define@boolkey[psset]{optexp}[POE@beam@]{startIn}[true]{}%
\define@boolkey[psset]{optexp}[POE@beam@]{stopIn}[true]{}%
\define@boolkey[psset]{optexp}[POE@beam@]{beamIn}[true]{}%
...
\def\Drawbeam@i{%
  ...
  \addto@pscode{%
     \pst@optexpdict 
     1 setlinejoin
     /drawFirstInner \ifPOE@beam@startIn true \else false \fi def
     /drawLastInner \ifPOE@beam@stopIn true \else false \fi def
     /drawOtherInner \ifPOE@beam@beamIn true \else false \fi def
...
\def\Drawbeam@ii{%
   \ifPOE@beam@beamConnectComp
      \ConnectComponents@iii
   \else
      ...
      \expandafter\def\csname #2@i\endcsname(##1)(##2)(##3)(##4)##5{%
         ...
         \begin@OptexpObj
            ...
            \psset{angleA=! \pst@optexpdict N@\optexp@nodeB\space N@\optexp@nodeA\space FiberAngleA end,
                   angleB=! \pst@optexpdict N@\optexp@nodeB\space N@\optexp@nodeA\space FiberAngleB end}
            \pccurve[style=FiberIn1](##1)(\optexp@nodeA @1)
            \pccurve[style=FiberIn2](##2)(\optexp@nodeA @2)
            \pccurve[style=FiberOut1](\optexp@nodeB @1)(##3)
            \pccurve[style=FiberOut2](\optexp@nodeB @2)(##4)
         \end@OptexpObj
      }%
      \@namedef{#2@ii}{%
        \pnode(0,0){\optexp@nodeLabel}%
...
\def\wdmsplitter@i(#1)(#2)(#3)#4{%
   \begin@OptexpObj
      ...
      % 
      % connect the fibers
      \pccurve[style=FiberIn](#1)(\optexp@nodeA @)     
      \pccurve[style=FiberOut1](\optexp@nodeB @1)(#2)
      \pccurve[style=FiberOut2](\optexp@nodeB @2)(#3)
   \end@OptexpObj
}%
%
%
...
\def\wdmcoupler@i(#1)(#2)(#3)#4{%
   \begin@OptexpObj
      ...
      % 
      % connect the fibers
      \pccurve[style=FiberOut](\optexp@nodeB @)(#3)
      \pccurve[style=FiberIn1](#1)(\optexp@nodeA @1)
      \pccurve[style=FiberIn2](#2)(\optexp@nodeA @2)
   \end@OptexpObj
}%
...
%\newOptexpFiberQuadrupole{optcrossswitch}{}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% default settings
...
% fiber optics
        ...
        ,compshift=0
        ,connjoin=1
%        ,crossswitchwidth=0.4
%        ,crossswitchheight=0.4
%        ,crossswitchsep=0.05
        %
        % beam
        ,startIn=false
...
\def\doveprism@comp{%
  \newOptexpComp{ {\POK@doveprism@size\space neg 0} {1 1} trans {NewPlaneInt}
                  ...
                  {\POK@doveprism@size\space neg 0} {1 1} trans {NewPlaneInt} \POK@refractiveindex }%
\ignorespaces}%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
\def\optcoupler@iii{%
   ...
   \ifx\POK@coupler@type\POS@coupler@type@none
      \pnode(! \@sz -0.5 mul @yshift \@sep add){\optexp@nodeA @1}
      \pnode(! \@sz -0.5 mul @yshift \@sep sub){\optexp@nodeA @2}
      \pnode(! \@sz 0.5 mul @yshift \@sep add){\optexp@nodeB @1}
      \pnode(! \@sz 0.5 mul @yshift \@sep sub){\optexp@nodeB @2}
      \psline[style=Fiber](\optexp@nodeA @1)(\optexp@nodeB @1)
      \psline[style=Fiber](\optexp@nodeA @2)(\optexp@nodeB @2)
   ...
   \else\ifx\POK@coupler@type\POS@coupler@type@crossswitch
      ...
      \psline(! \@csz neg dup \@sep add)(! \@csz dup \@sep add)
      \psline(! \@csz neg \@csz \@sep add)(! \@csz dup neg \@sep add)
   \fi\fi
      \pnode(! \@sz neg \getCLW 0.3 mul add @yshift \@sep add){\optexp@nodeA @1}
      \pnode(! \@sz neg \getCLW 0.3 mul add @yshift \@sep sub){\optexp@nodeA @2}
      \pnode(! \@sz \getCLW 0.3 mul sub @yshift \@sep add){\optexp@nodeB @1}
      \pnode(! \@sz \getCLW 0.3 mul sub @yshift \@sep sub){\optexp@nodeB @2}
...
\def\wdmcoupler@ii{%
   ...
   \ifx\POK@coupler@type\POS@coupler@type@elliptic
      ...
      \pnode(! \@sz neg \getCLW 0.3 mul add @yshift \@sep sub){\optexp@nodeA @2}
      \pnode(!0 @yshift){\optexp@nodeLabel}
      \pnode(! \@sz \getCLW 0.3 mul sub 0){\optexp@nodeB @}      
   \else\ifx\POK@coupler@type\POS@coupler@type@none
      \pnode(0,0){\optexp@nodeA @1}
      \pnode(0,0){\optexp@nodeA @2}
...
\def\wdmsplitter@ii{%
   ...
   \ifx\POK@coupler@type\POS@coupler@type@elliptic
      \psellipse[dimen=outer](! 0 @yshift)(! \@sz \@sz 0.4 mul)
      \pnode(! \@sz neg \getCLW 0.3 mul add 0){\optexp@nodeA @}
      \pnode(! \@sz \getCLW 0.3 mul sub @yshift \@sep add){\optexp@nodeB @1}
      \pnode(! \@sz \getCLW 0.3 mul sub @yshift \@sep sub){\optexp@nodeB @2}
      \pnode(! 0 @yshift){\optexp@nodeLabel}
   \else\ifx\POK@coupler@type\POS@coupler@type@none
      \pnode(0,0){\optexp@nodeA @}
      \pnode(0,0){\optexp@nodeB @1}
      \pnode(0,0){\optexp@nodeB @2}
      \pnode(0,0){\optexp@nodeLabel}
   \fi\fi
}%
%
