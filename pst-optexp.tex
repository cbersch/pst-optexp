...
%   \psline[style=FiberOut](\psk@optexp@basicname A)(\optexp@nodeA)
   \pccurve[angleA=180, angleB=0, style=FiberIn](\psk@optexp@basicname A)(\optexp@nodeA)
}%
\def\psoe@cs@out@f{%
%   \psline[style=FiberOut](\optexp@nodeB)(\psk@optexp@basicname B)
   \pccurve[angleA=180, angleB=0, style=FiberOut](\optexp@nodeB)(\psk@optexp@basicname B)
}%
\def\psoe@cs@in@i{%
...
%
\def\pentaprism@iii{%
   \edef\@pp@size{\psk@optexp@pentaprism@size\space 0.5 mul\space}%
   \pscustom{%
...
\def\rightangleprism@iii{%
   % 
   \pst@Verb{/prism@size \psk@optexp@raprism@size\space 0.5 mul def }%
