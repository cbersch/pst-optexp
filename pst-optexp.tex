...
\def\optexp@@@@getcomps#1\@nil{%
  ...
  \else\ifcat a\pst@tempb\relax
    \optexp@getcomp{(OE@#1)}%
  \else
    \optexp@getcomp{(OE@\POS@optexp@basicname@default#1)}%
  \fi\fi%
  \optexp@@getcomps%
}%
...
\def\optexp@getnode#1\@nil{%
  ...
  \else\ifcat\pst@tempb a\relax
    \optexp@getcomp{(#1)}%
  \else
    \optexp@getcomp{(\POS@optexp@basicname@default#1)}%
  \fi\fi%
}%
...
%  \edef\poe@tmp{\the\poe@cnt}% I don't know how to do it with expansion
  \ifPOE@beam
    \ifPOE@endbox
      \drawbeam{(\optexp@nodeA)}{\POK@basicname}.
    \else
      \drawbeam{(\optexp@nodeA)}{\POK@basicname}{(\optexp@nodeB)}.
    \fi
  \else
    \ifPOE@endbox
      \ifPOE@fiberin@
