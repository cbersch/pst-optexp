...
\def\@oedict#1{\pst@optexpdict #1 end}
\SpecialCoor
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\def\pst@str@filtertype@lowpass{lowpass}
\def\pst@str@filtertype@highpass{highpass}
\def\pst@str@couplertype@none{none}
\def\pst@str@couplertype@elliptic{elliptic}
\def\pst@str@couplertype@rectangular{rectangular}
...
\def\drawfiber@i[#1]#2#3{%
  ...
  \begingroup
    ...
    %       
    \ifPst@oe@bglayer
      \ifx\psk@oe@startnode\pst@str@autonode\else
        \pnode(! /\psk@oe@startnode\space \optexp@comps exch pop \@oedict{getsubnode} \tx@UserCoor){@@A}
      \fi
      \ifx\psk@oe@stopnode\pst@str@autonode\else
        \pnode(! /\psk@oe@stopnode\space \optexp@comps pop \@oedict{getsubnode} \tx@UserCoor){@@B}
      \fi
      \ifx\psk@oe@startnode\pst@str@autonode
        \ifx\psk@oe@stopnode\pst@str@autonode
          \pnode(! \optexp@comps exch \@oedict{NearestNode} \tx@UserCoor){@@A}
          \pnode(! \optexp@comps \@oedict{NearestNode} \tx@UserCoor){@@B}
        \else
          \pnode(! \optexp@comps exch pop /N@@@B \@oedict{@GetCenter ToVec NearestNode} \tx@UserCoor){@@A}
        \fi
      \else\ifx\psk@oe@stopnode\pst@str@autonode
        \pnode(! \optexp@comps pop /N@@@A \@oedict{@GetCenter ToVec NearestNode} \tx@UserCoor){@@B}
      \fi\fi
      \pst@getcoor{@@A}\pst@tempa
      \pst@getcoor{@@B}\pst@tempb
      \ifx\psk@angleA\relax
        \psset{angleA=! \@oedict{\pst@tempb \pst@tempa \optexp@comps exch RelFiberAngle}}%
      \else
        \ifPst@oe@relangle
          \psset{angleA=! \@oedict{\pst@tempb \pst@tempa \optexp@comps exch RelFiberAngle} \psk@angleA\space add}%
        \fi
      \fi
      \ifx\psk@angleB\relax
        \psset{angleB=! \@oedict{\pst@tempa \pst@tempb \optexp@comps RelFiberAngle}}%
      \else
        \ifPst@oe@relangle
          \psset{angleB=! \@oedict{\pst@tempa \pst@tempb \optexp@comps RelFiberAngle} \psk@angleB\space add }%
      \fi\fi
      \nccurve{@@A}{@@B}
    \fi
  \endgroup
...
\def\newOptexpComp@i[#1]#2{%
    \pst@OptexpVerb{#1 [ #2 (\psk@oe@b@sicname) {\tx@ScreenCoor} false NewOptexpComp}%
}%
\def\newOptexpCompAmb{\@ifnextchar[{\newOptexpCompAmb@i}{\newOptexpCompAmb@i[]}}%
\def\newOptexpCompAmb@i[#1]#2{%
    \pst@OptexpVerb{#1 [ #2 (\psk@oe@b@sicname) {\tx@ScreenCoor} true NewOptexpComp}%
}%
\def\optplane(#1)(#2)#3{%
    \pst@getcoor{#1}\pst@tempOrig%
    \pst@getcoor{#2}\pst@tempDiff%
    \pst@OptexpVerb{{\pst@tempOrig} gsave STV CP T exec grestore ToVec {\pst@tempDiff} (\pst@str@basicname@prefix#3) {} NewNodeComp}%
\ignorespaces}%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% END %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      %
       ...
       \ifPst@oe@bglayer
         ...
         \ifPst@oe@fiberin@top
           \drawfiber@{FiberIn1}[stopnode=1]{(##1)}{\psk@oe@compname}
         \fi
         \ifPst@oe@fiberin@bottom
           \drawfiber@{FiberIn2}[stopnode=2]{(##2)}{\psk@oe@compname}
         \fi
         \ifPst@oe@fiberout@top
           \drawfiber@{FiberOut}[startnode=3]{\psk@oe@compname}{(##3)}
         \fi
         \ifPst@oe@fiberout@bottom
           \drawfiber@{FiberOut2}[startnode=N]{\psk@oe@compname}{(##4)}
         \fi
       \fi
     \end@OptexpObj
    }%
...
\def\wdmsplitter@i(#1)(#2)(#3)#4{%
  ...
  \begin@OptexpObj
    ...
    \ifPst@oe@bglayer
      % connect the fibers
      \ifPst@oe@fiberin@
        \drawfiber@{FiberIn}[stopnode=1]{(#1)}{\psk@oe@compname}
      \fi
      \ifPst@oe@fiberout@top
        \drawfiber@{FiberOut1}[startnode=2]{\psk@oe@compname}{(#2)}
      \fi
      \ifPst@oe@fiberout@bottom
        \drawfiber@{FiberOut2}[startnode=N]{\psk@oe@compname}{(#3)}
      \fi
    \fi
  \end@OptexpObj
}%
...
\def\wdmcoupler@i(#1)(#2)(#3)#4{%
  ...
  \begin@OptexpObj
    ...
    \ifPst@oe@bglayer 
      % connect the fibers
      \ifPst@oe@fiberout@
        \drawfiber@{FiberOut}[startnode=N]{\psk@oe@compname}{(#3)}
      \fi
      \ifPst@oe@fiberin@top
        \drawfiber@{FiberIn1}[stopnode=1]{(#1)}{\psk@oe@compname}
      \fi
...
\def\pst@calcNodes#1#2#3{{%
  ...
  \pnode(! \@oedict{X@B Y@B}){\oenoderefb{}}%
  \pst@OptexpVerb{/@xref \psk@oe@xref\space def /@yref \psk@oe@yref\space def}%
}\ignorespaces}%
%
%
...
\def\put@comp#1#2{%
  ...
  \ifdim\psk@oe@angle pt=0pt
    \put@@comp{#2}
  \else
    \psrotate(! \@oedict{@@x0 @@x \psk@oe@rotate@xref\space mul add
                         @@y0 @@y \psk@oe@rotate@yref\space mul add}){\psk@oe@angle}{\put@@comp{#2}}%
  \fi
}%
\def\put@@comp#1{%
...
\def\put@Label#1{%
   ...
   \else\ifx\psk@oe@labelref\pst@str@labelref@relgrav
      %
      % relgrav
      \rput[\psk@oe@labelalign](\oenodelabel{}){\psk@oe@labelstyle #1}%
      %
...
\def\pst@draw@component@i[#1]#2#3{%
    ...
    \def\@@comp{%
       ...
       \ifx\psk@oe@extnode\@empty\else
          \ifPst@oe@bglayer
            \pnode(! \@oedict{ExtNode}){\psk@oe@extnoden@me}%
          \fi
       \fi
    }%
    \ifPst@oe@endbox%
    ...
    % then check if absolute positioning is wanted
        \ifx\psk@oe@abspos\@empty
           \ncput[nrot=:U,npos=]{\put@comp{#1}{\@@comp}}%
        \else
           \nlput[nrot=:U](\oenoderefa{})(\oenoderefb{}){\psk@oe@abspos}{\put@comp{#1}{\@@comp}}%
        \fi
    \else
       \ncput[nrot=:U,npos=\psk@oe@position]{\put@comp{#1}{\@@comp}}%
    \fi
    \endgroup
    %
    \ifPst@oe@toplayer
...
\def\oeifcnodes@i#1{%
  ...
  \addto@pscode{
    ...
    \@oedict{[ (#1) false GetInternalBeamNodes %]
...
\def\dipole@nodes{%
  ...
  \pnode(! \@oedict{@@x0 @@y0}){\oenodecenter{}}
\ignorespaces}%
\def\fiberdipole@nodes{%
  \pnode(! \@oedict{@@x0 @@x sub 0}){\oenodein{}}
  \pnode(! \@oedict{@@x0 @@x add 0}){\oenodeout{}}
  \pnode(! \@oedict{@@x0 @@y0}){\oenodecenter{}}
}%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
\def\mirror@ref{%
  \ifx\psk@oe@mirrortype\pst@str@mirrortype@piezo
    ...
    \bgroup
      ...
      \pst@OptexpVerb{\pst@number\psyunit @@y0 div \psk@oe@mirrorwidth\space 0.5 mul mul 2.5 div /@@y0 ED}%
    \egroup
  \else\ifdim\psk@oe@mirrorradius pt=0pt
    \pst@OptexpVerb{/@@x \psk@oe@mirrorwidth\space 0.5 mul def}%
  \fi\fi
}%
\def\mirror@nodes{%
   \newOptexpComp{{ 0 0 } 
...
\def\mirror@comp{%
  \edef\@ht{\psk@oe@mirrorwidth\space\pst@number\psyunit mul 0.5 mul }%
  \edef\@dp{\psk@oe@mirrordepth\space\pst@number\psxunit mul }%
  \edef\@r{\psk@oe@mirrorradius\space\pst@number\psxunit mul }%
  ...
  \else
    ...
    % plain mirror 
    %
    \edef\@ht{\psk@oe@mirrorwidth\space 0.5 mul }%
    \ifPst@oe@variable
    ...
    \else\ifx\psk@oe@mirrortype\pst@str@mirrortype@extended%
      ...
      \psframe[style=ExtendedMirror]%
         (! \@ht neg \psk@oe@mirrordepth\space )%
         (! \@ht 0)%
    \fi\fi
    \psline[linewidth=\psk@oe@mirrorlinewidth](! \@ht neg \getCLWH)(! \@ht \getCLWH)
  \fi\fi
}%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
\def\lens@ref{%
  \pst@OptexpVerb{/@@y \psk@oe@lensheight\space 0.5 mul def}%
}%
\def\lens@nodes{%
  \edef\@lens@th{0}% 
...
%
\def\pinhole@ref{%
  \pst@OptexpVerb{/@@y \psk@oe@outerheight\space 0.5 mul def}%
\ignorespaces}%
\def\pinhole@comp{%
...
\def\beamsplitter@nodes{%
  \edef\@bs@wd{\psk@oe@bssize\space 2.0 div }%
...
\def\crystal@comp{%
  \edef\@wd{\psk@oe@crystalwidth\space 0.5 mul }
  \edef\@ht{\psk@oe@crystalheight\space 0.5 mul }
  ...
  \fi
  \ifPst@oe@lamp
    \rput{180}(! \@wd \@ht 1.4 \psk@oe@lampscale\space mul add){\crystal@lamp}%
  \fi
  \ifdim\psk@oe@caxislength pt>0pt
    \edef\@c@caxisL{\psk@oe@caxislength\space 2 div }%
    \ifPst@oe@caxisinv
      % invert the c-axis
...
\def\polarization@comp{%
  \edef\@pol@size{\psk@oe@polsize\space 0.5 mul }%
...
%
\def\optgrid@ref{%
  \pst@OptexpVerb{/@@y0 \psk@oe@optgridheight\space def
                  /@@x \psk@oe@optgridwidth\space 0.5 mul def}%
}%
\def\optgrid@comp{%
  \edef\@cnt{\psk@oe@optgridcount\space}%
  \edef\@wd{\psk@oe@optgridwidth\space 2 div }%
  \edef\@ht{\psk@oe@optgridheight\space}%
  \edef\@dp{\psk@oe@optgriddepth\space}%
  \edef\@step{\psk@oe@optgridwidth\space\@cnt div }%
...
\def\optbox@comp{%
  \edef\@wd{\psk@oe@optboxwidth\space 0.5 mul }
  \edef\@ht{\psk@oe@optboxheight\space 0.5 mul }
  \ifPst@oe@endbox
...
%
\def\optplate@ref{%
  \pst@OptexpVerb{/@@y \psk@oe@plateheight\space 0.5 mul def }%
}%
\def\optplate@comp{%
   \psline[linewidth=\psk@oe@platelinewidth](! \@oedict{0 @@y neg})(! \@oedict{0 @@y})
\ignorespaces}%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%
\def\optdetector@ref{%
  \pst@OptexpVerb{/@@x0 \psk@oe@detsize\space 0.5 mul def}%
  \ifx\psk@oe@dettype\pst@str@dettype@diode
...
\def\optdetector@nodes{%
  ...
  \ifx\psk@oe@dettype\pst@str@dettype@round
    \pnode(! \psk@oe@detsize\space 0.2 mul 0){\oenodecenter{}}%
  \else\ifx\psk@oe@dettype\pst@str@dettype@diode
    \pnode(! \psk@oe@detsize\space 0.5 mul 0){\oenodecenter{}}
  \fi\fi
}%
\def\optdetector@comp{%
   ...
   \ifx\psk@oe@dettype\pst@str@dettype@round
      ...
      \end@ClosedObj
   \else\ifx\psk@oe@dettype\pst@str@dettype@diode
      \edef\@sz{\psk@oe@detsize\space 0.5 mul }%
...
\def\optretplate@ref{%
   \pst@OptexpVerb{%
     /@@y \psk@oe@plateheight\space 0.5 mul def
     /@@x \psk@oe@platewidth\space 0.5 mul def
   }%
}%
\def\optretplate@comp{%
   \edef\@ht{\psk@oe@plateheight\space 0.5 mul }%
   \edef\@wd{\psk@oe@platewidth\space 0.5 mul }%
   \psframe(! \@wd neg \@ht neg)(! \@wd \@ht)
...
%
\def\optdiode@ref{%
   \pst@OptexpVerb{\psk@oe@optdiodesize\space 0.5 mul dup /@@y ED /@@x ED }%
}%
\def\optdiode@comp{%
...
\ignorespaces}%
\def\doveprism@comp{%
   \edef\@ht{\psk@oe@doveprismsize\space 0.5 mul }%
   \edef\@wd{\psk@oe@doveprismsize\space 1.5 mul }%
...
\def\optprism@nodes{%
   ...
   \edef\@altan{\psk@oe@prismangle\space 0.5 mul tan }%
...
\def\rightangleprism@nodes{%
  \edef\@sz{\psk@oe@raprismsize\space 0.5 mul }%
  \edef\@ht{\@oedict{OEangle 0.5 mul sin modA mul} }%
...
%
\def\optmzm@ref{%
  \pst@OptexpVerb{\psk@oe@optmzmsize\space dup 0.8 mul /@@x ED 0.5 mul /@@y ED }%
}%
\def\optmzm@comp{%
  \def\@wd{\psk@oe@optmzmsize\space 0.8 mul }%
  \def\@ht{\psk@oe@optmzmsize\space 0.5 mul }%
  \bgroup
...
%
\def\optfilter@ref{%
  \pst@OptexpVerb{\psk@oe@filtersize\space 0.5 mul dup /@@y ED /@@x ED }%
}%
\def\optfilter@comp{%
  \edef\@sz{\psk@oe@filtersize\space 0.5 mul }%
  \def\filter@curve{%
  ...
  \else\ifx\psk@oe@filtertype\pst@str@filtertype@bandstop
    ...
    \rput(! 0 -0.5 \@sz mul){%
      ...
      \rput(! 0 0.5 \@sz mul){%
        ...
        \fi
        \filter@curve}
  \else\ifx\psk@oe@filtertype\pst@str@filtertype@lowpass
    \psline(! -0.3 \@sz mul -0.15 \@sz mul)%
           (! 0.3 \@sz mul 0.15 \@sz mul)%
    \psline(! -0.3 \@sz mul 0.35 \@sz mul)%
           (! 0.3 \@sz mul 0.65 \@sz mul)%
    \rput(! 0 -0.5 \@sz mul){%
      ...
      \rput(0, 0){\filter@curve}
      \rput(! 0 0.5 \@sz mul){\filter@curve}
  \else\ifx\psk@oe@filtertype\pst@str@filtertype@highpass
    \psline(! -0.3 \@sz mul -0.15 \@sz mul)%
           (! 0.3 \@sz mul 0.15 \@sz mul)%
    \psline(! -0.3 \@sz mul -0.65 \@sz mul)%
           (! 0.3 \@sz mul -0.35 \@sz mul)%
...
%
\def\optamp@nodes{%
  \edef\@sz{\psk@oe@optampsize\space 0.5 mul }%
...
%
\def\optisolator@ref{%
  \pst@OptexpVerb{\psk@oe@isolatorsize\space dup 0.8 mul /@@x ED 0.5 mul /@@y ED }%
}%
\def\optisolator@comp{%
  \edef\@ht{\psk@oe@isolatorsize\space 0.5 mul }%
  \edef\@wd{\psk@oe@isolatorsize\space 0.8 mul }%
  \psframe[dimen=outer](! \@wd neg \@ht neg)(! \@wd \@ht)
...
\def\optfiberpolarizer@ref{%
  \pst@OptexpVerb{\psk@oe@fiberpolsize\space dup 0.8 mul /@@x ED 0.5 mul /@@y ED }%
}%
\def\optfiberpolarizer@comp{%
  \edef\@ht{\psk@oe@fiberpolsize\space 0.5 mul }%
  \edef\@wd{\psk@oe@fiberpolsize\space 0.8 mul }%
  \psframe[dimen=outer](! \@wd neg \@ht neg)(! \@wd \@ht)
...
%
\def\optswitch@ref{%
  \pst@OptexpVerb{\psk@oe@switchsize\space 0.5 mul dup /@@y ED /@@x ED }%
}%
\def\optswitch@comp{%
  \edef\@sz{\psk@oe@switchsize\space 0.5 mul }%
...
\def\fiberdelayline@ref{%
  \pst@OptexpVerb{\psk@oe@fdlsize\space dup 0.8 mul /@@x ED 0.5 mul /@@y ED }%
}%
\def\fiberdelayline@comp{%
  \def\@wd{\psk@oe@fdlsize\space 0.8 mul }%
  \def\@ht{\psk@oe@fdlsize\space 0.5 mul }%
  \psframe[dimen=outer](! \@wd neg \@ht neg)(! \@wd \@ht)
...
\def\optcoupler@nodes{%
  ...
  \edef\@sep{\psk@oe@couplersep\space 0.5 mul }%
  \ifx\psk@oe@align\pst@str@top
    \def\@yshift{\@sep neg }%
  \else\ifx\psk@oe@align\pst@str@bottom
...
\def\optcoupler@comp{%
  ...
  \else\ifx\psk@oe@couplertype\pst@str@couplertype@rectangular
  ...
  \else\ifx\psk@oe@couplertype\pst@str@couplertype@crossswitch
    \psframe[dimen=outer](!\@sz neg \@yshift \@sz sub )%
                         (!\@sz \@yshift \@sz add)
    \edef\@csz{\psk@oe@couplersize\space 0.5 mul }
...
\def\wdmcoupler@nodes{%
  ...
  \edef\@sep{\psk@oe@couplersep\space 0.5 mul }%
  \ifx\psk@oe@couplertype\pst@str@couplertype@none
    \ifx\psk@oe@align\pst@str@center
      \edef\@sep{0 }%
    \fi
  \fi
  %
...
\def\wdmcoupler@comp{%
  ...
  \else\ifx\psk@oe@couplertype\pst@str@couplertype@none
    \ifx\psk@oe@align\pst@str@top
      ...
      \psline[style=Fiber](! \pst@optexpdict /N@\oenodeout{} @GetCenter end \tx@UserCoor \psk@oe@couplersep\space sub)(\oenode{}{2})
    \else
      \psline[style=Fiber](\oenode{}{2})(\oenodeout{})
      \ifx\psk@oe@aling\pst@str@bottom
        \psline[style=Fiber](! \pst@optexpdict /N@\oenodein{} @GetCenter end \tx@UserCoor \psk@oe@couplersep\space sub)(\oenode{}{1}) 
      \fi
    \fi
  \fi\fi\fi
}%
...
\def\wdmsplitter@comp{%
  ...
  \else\ifx\psk@oe@couplertype\pst@str@couplertype@none
    \ifx\psk@oe@align\pst@str@top
      ...
      \psline[style=Fiber](! \pst@optexpdict /N@\oenodein{} @GetCenter end \tx@UserCoor \psk@oe@couplersep\space sub)(\oenode{}{N})
    \else
      \psline[style=Fiber](\oenodein{})(\oenode{}{N})
      \ifx\psk@oe@align\pst@str@bottom
        \psline[style=Fiber](! \pst@optexpdict /N@\oenodein{} @GetCenter end \tx@UserCoor \psk@oe@couplersep\space sub)(\oenode{}{2})
      \fi
    \fi
  \fi\fi\fi
}%
...
\def\fibercollimator@nodes{%
   \def\@sz{\psk@oe@fibercolsize\space 0.5 mul }%
