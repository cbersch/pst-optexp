...
\define@choicekey*[psset]{optexp}{namingscheme}[\val\nr]{old,new}[new]{%
  \ifcase\nr\relax
    % old naming scheme
    \edef\POS@basicname@default{tempNode}
    \edef\POS@basicname@prefix{}
    \edef\POS@extnode@postfix{ExtNode}
  \or
    \edef\POS@basicname@default{@}
    \edef\POS@basicname@prefix{OE@}
    \edef\POS@extnode@postfix{Ext}
  \fi
}%
%
% Positioning
...
\define@key[psset]{optexp}{compshift}{\pst@checknum{#1}\POK@compshift}
\define@key[psset]{optexp}{angle}{\pst@checknum{#1}\POK@angle}
%
% Layering
...
%
% Label
\define@key[psset]{optexp}{labelangle}{\pst@checknum{#1}\POK@labelangle}
\define@key[psset]{optexp}{labeloffset}{\pst@checknum{#1}\POK@labeloffset}
...
\define@key[psset]{optexp}{ref@angle}{\pst@checknum{#1}\POK@labelrefangle}%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% 
% Lens
\define@key[psset]{optexp}{lensheight}{\pst@checknum{#1}\POK@lensheight}
\define@key[psset]{optexp}{lenswidth}{\pst@checknum{#1}\POK@lenswidth}
\define@key[psset]{optexp}{lensradiusleft}{\pst@checknum{#1}\POK@lensradiusleft}
\define@key[psset]{optexp}{lensradiusright}{\pst@checknum{#1}\POK@lensradiusright}
...
%
% Pinhole
\define@key[psset]{optexp}{innerheight}{\pst@checknum{#1}\POK@innerheight}
\define@key[psset]{optexp}{outerheight}{\pst@checknum{#1}\POK@outerheight}
\define@key[psset]{optexp}{phlinewidth}{\edef\POK@phlinewidth{#1}}
%
% Crystal
\define@key[psset]{optexp}{crystalwidth}{\pst@checknum{#1}\POK@crystalwidth}
\define@key[psset]{optexp}{crystalheight}{\pst@checknum{#1}\POK@crystalheight}
\define@key[psset]{optexp}{caxislength}{\pst@checknum{#1}\POK@caxislength}
...
\define@key[psset]{optexp}{lampscale}{\pst@checknum{#1}\POK@lampscale}
%
% Box
\define@key[psset]{optexp}{optboxwidth}{\pst@checknum{#1}\POK@optboxwidth}
\define@key[psset]{optexp}{optboxheight}{\pst@checknum{#1}\POK@optboxheight}
\define@boolkey[psset]{optexp}[POE@]{endbox}[true]{}
%
% Plate
\define@key[psset]{optexp}{platelinewidth}{\edef\POK@platelinewidth{#1}}
\define@key[psset]{optexp}{plateheight}{\pst@checknum{#1}\POK@plateheight}
%
% Optical Retardation Plate
\define@key[psset]{optexp}{platewidth}{\pst@checknum{#1}\POK@platewidth}
%
% Detector
\define@key[psset]{optexp}{detsize}{\pst@checknum{#1}\POK@detsize}
\define@choicekey+[psset]{optexp}{dettype}[\val\nr]{round,diode}%
   {\edef\POK@dettype{\val}}
   {\PackageError{pst-optexp}{Unknown value '\val' for key dettype}}
%
% Polarization
\define@key[psset]{optexp}{polsize}{\pst@checknum{#1}\POK@polsize}
...
%
% Optical Diode
\define@key[psset]{optexp}{optdiodesize}{\pst@checknum{#1}\POK@optdiodesize}
%
% Dove Prism
\define@key[psset]{optexp}{doveprismsize}{\pst@checknum{#1}\POK@doveprismsize}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Tripoles
%
% Beamsplitter
\define@key[psset]{optexp}{bssize}{\pst@checknum{#1}\POK@bssize}
\define@key[psset]{optexp}{bsstyle}{\edef\POK@bsstyle{#1}}
%
% Mirror
\define@key[psset]{optexp}{mirrorwidth}{\pst@checknum{#1}\POK@mirrorwidth}
...
\define@key[psset]{optexp}{mirrordepth}{\pst@checknum{#1}\POK@mirrordepth}
\define@key[psset]{optexp}{mirrorradius}{\pst@checknum{#1}\POK@mirrorradius}
\define@boolkey[psset]{optexp}[POE@]{variable}[true]{}
%
% Grid
\define@key[psset]{optexp}{optgridcount}{\pst@checknum{#1}\POK@optgridcount}
\define@key[psset]{optexp}{optgridwidth}{\pst@checknum{#1}\POK@optgridwidth}
\define@key[psset]{optexp}{optgridheight}{\pst@checknum{#1}\POK@optgridheight}
\define@choicekey*[psset]{optexp}{optgridtype}[\val\nr]{binary,blazed}{\edef\POK@optgridtype{#1}}%
\define@key[psset]{optexp}{optgriddepth}{\pst@checknum{#1}\POK@optgriddepth}
\define@key[psset]{optexp}{optgridlinewidth}{\edef\POK@optgridlinewidth{#1}}
\define@boolkey[psset]{optexp}[POE@]{reverse}[true]{}
%
%
\define@key[psset]{optexp}{refractiveindex}{\pst@checknum{#1}\POK@n}
\define@key[psset]{optexp}{n}{\pst@checknum{#1}\POK@n}
\define@key[psset]{optexp}{nmul}{\edef\POK@nmul{#1}}
\define@key[psset]{optexp}{nadd}{\edef\POK@nadd{#1}}
%
% Penta Prism
\define@key[psset]{optexp}{pentaprismsize}{\pst@checknum{#1}\POK@pentaprismsize}
%
% Right-Angle Prism
\define@key[psset]{optexp}{raprismsize}{\pst@checknum{#1}\POK@raprismsize}
%
% Prism
\define@key[psset]{optexp}{prismsize}{\pst@checknum{#1}\POK@prismsize}
\define@key[psset]{optexp}{prismangle}{\pst@checknum{#1}\POK@prismangle}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%
% Fiber
\define@key[psset]{optexp}{fiberloops}{\pst@checknum{#1}\POK@fiberloops}
\define@key[psset]{optexp}{fiberloopradius}{\pst@checknum{#1}\POK@fiberloopradius}
\define@key[psset]{optexp}{fiberloopsep}{\pst@checknum{#1}\POK@fiberloopsep}
%
% Filter
\define@key[psset]{optexp}{filtersize}{\pst@checknum{#1}\POK@filtersize}
...
\define@key[psset]{optexp}{polcontrolsize}{\pst@checknum{#1}\POK@polcontrolsize}
%
% Optical amplifier
\define@key[psset]{optexp}{optampsize}{\pst@checknum{#1}\POK@optampsize}
%
% Mach-Zehnder modulator
\define@key[psset]{optexp}{optmzmsize}{\pst@checknum{#1}\POK@optmzmsize}
%
% Isolator
\define@key[psset]{optexp}{isolatorsize}{\pst@checknum{#1}\POK@isolatorsize}
%
% Fiber polarizer
\define@key[psset]{optexp}{fiberpolsize}{\pst@checknum{#1}\POK@fiberpolsize}
%
% Optical switch
\define@key[psset]{optexp}{switchsize}{\pst@checknum{#1}\POK@switchsize}
...
%
% Fiber delay line
\define@key[psset]{optexp}{fdlsize}{\pst@checknum{#1}\POK@fdlsize}
%
% Fiber collimator 
\define@key[psset]{optexp}{fibercolsize}{\pst@checknum{#1}\POK@fibercolsize}
%
% Coupler
\define@key[psset]{optexp}{couplersize}{\pst@checknum{#1}\POK@couplersize}
\define@key[psset]{optexp}{coupleroutshift}{\pst@checknum{#1}\POK@coupleroutshift}
\define@key[psset]{optexp}{couplersep}{\pst@checknum{#1}\POK@couplersep}
...
\def\drawextendedbeam@iii{%
  ...
  % the start positions
  \addto@pscode{%
    [\ifx\POK@startpos\@empty 0 0 \else\POK@startpos\space\fi
  ...
  \ifx\psk@fillstyle\relax
    ...
    \else
       ...
       \addto@pscode{ newpath 
                      gsave 
                        \pst@number\pslinewidth SLW \pst@usecolor\pslinecolor \tx@setStrokeTransparency 
                        StrokeExtendedBeam \@nameuse{psls@\pslinestyle} 
                      grestore }%
    \fi
  \else
    ...
    \addto@pscode{ FillExtendedBeam grestore }%
    \ifx\pslinestyle\@none\else
...
%  \edef\poe@tmp{\the\poe@cnt}% I don't know how to do it with expansion
  \ifPOE@beam
    \ifPOE@endbox
      \drawbeam[addtoBeam={beamConnectComp}]{(\optexp@refnodeA)}{\POK@compname}
    \else
      \drawbeam[addtoBeam={beamConnectComp}]{(\optexp@refnodeA)}{\POK@compname}{(\optexp@refnodeB)}
    \fi
  \else
    \ifPOE@endbox
      \ifPOE@fiberin@
        \drawfiber@{FiberIn}{(\optexp@refnodeA)}{\POK@compname}
      \fi
    \else
      \ifPOE@fiberin@
        \drawfiber@{FiberIn}{(\optexp@refnodeA)}{\POK@compname}
              \fi
      \ifPOE@fiberout@
        \drawfiber@{FiberOut}{\POK@compname}{(\optexp@refnodeB)}
      \fi
    \fi
  \fi
}%
...
\def\optexp@refnodeA{\POK@b@sicname A}%
\def\optexp@refnodeB{\POK@b@sicname B}%
...
\def\newOptexpComp@i[#1]#2{%
    \pst@Verb{\pst@optexpdict #1 [ #2 (\POK@b@sicname) {\tx@ScreenCoor} false NewOptexpComp end}%
}%
\def\newOptexpCompAmb{\@ifnextchar[{\newOptexpCompAmb@i}{\newOptexpCompAmb@i[]}}%
\def\newOptexpCompAmb@i[#1]#2{%
    \pst@Verb{\pst@optexpdict #1 [ #2 (\POK@b@sicname) {\tx@ScreenCoor} true NewOptexpComp end}%
}%
\def\optplane(#1)(#2)#3{%
      ...
      %
        \ifPOE@bglayer
          ...
          \else
            ...
            \pnode(!\pst@tempA\pst@number\psyunit div exch \pst@number\psxunit div exch
                    \pst@tempB\pst@number\psyunit div exch \pst@number\psxunit div exch 
                    \pst@optexpdict mwNode end){\optexp@refnodeB}
         \fi\fi
       \fi
       %
  ...
  \begin@OptexpObj
    \ifPOE@bglayer
      ...
      \else
         ...
         \pnode(!\pst@tempA\pst@number\psyunit div exch \pst@number\psxunit div exch
                 \pst@tempB\pst@number\psyunit div exch \pst@number\psxunit div exch 
                 \pst@optexpdict mwNode end \POK@coupleroutshift\space add){\optexp@refnodeB}
      \fi\fi
    \fi
    %
...
%        4 copy pop exch pop le % xA xB
      ...
      \ifx\POK@position\@empty
         ...
         \else
            \nlput[nrot=:U](\optexp@refnodeA)(\optexp@refnodeB){\POK@abspos}{\put@RelLabel{#1}}%
         \fi
      \else
   ...
   \begin@OptexpObj
      ...
      \ifPOE@bglayer
        ...
        \ifPOE@compat
          \@nameuse{\psk@connIn}
        \else
          \drawbeam{(\optexp@refnodeA)}{\poe@tmp}
        \fi
        \ifPOE@fiberout@
          \ifx\@empty\pst@tempC
            \ifPOE@compat
              \@nameuse{\psk@connOut}
            \else
              \drawfiber{\poe@tmp}{(\optexp@refnodeB)}
            \fi
...
%    \message{^^J\POK@compname^^J}
    ...
    % then check if absolute positioning is wanted
        ...
        \else
           \nlput[nrot=:U](\optexp@refnodeA)(\optexp@refnodeB){\POK@abspos}{\put@Comp{\@@comp}}%
        \fi
    \else
...
\def\optbox@nodes{%
  ...
  \else
    \psrotate(! \@wd \POK@rotate@xref\space mul
                \@ht \POK@rotate@yref\space mul){\POK@angle}{%
      \newOptexpComp{{ \@wd neg 0 } { 0 1 } trans {NewPlaneInt} { \@wd 0 } { 0 1 } trans {NewPlaneInt} \POK@n }%
      \pnode(0, 0){\optexp@nodeLabel}%   
    }%
  \fi
...
\def\optdetector@nodes{%
  ...
  \else\ifx\POK@dettype@diode
    ...
    \pst@Verb{\POK@detsize\space 0.5 mul dup dup /@@x0 ED /@@x ED /@@y ED}%
  \fi\fi
}%
