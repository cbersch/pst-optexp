...
\begin{pspicture}(5,2)
  ...
  \doveprism(A)(B){}
  \addtopsstyle{Beam}{beamConnectComp}
  \drawbeam[addtoBeam={linecolor=red}, startpos=0 -0.1, invec=1 -0.04]{(A)}{1}{(B)}.
  \drawbeam[addtoBeam={linecolor=black}]{(A)}{1}{(B)}.
  \drawbeam[startpos=0 0.1, invec=1 0.04]{(A)}{1}{(B)}.
\end{pspicture}
...
\begin{pspicture}[showgrid=true](10, 5)
  \pnode(10, 2){Ref}
  \newOptexpPlane(Ref)(0,1){RefPlane}
