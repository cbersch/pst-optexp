\begin{pspicture}[showgrid](4,1.5)
...
\begin{pspicture}[showgrid](5,2)
  ...
  \drawbeam[beampathstart=2](A){1-2}
  \drawbeam[beampathstart=2, savebeam, linestyle=dashed, dash=2pt 2pt, linecolor=red,arrowscale=1.5, arrows=->](A){1}{3}
  \end{optexp}
