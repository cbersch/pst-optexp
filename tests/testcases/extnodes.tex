...
\begin{pspicture}(3,2)
  ...
  \makeatletter
  \POE@extnodes[style=MyDot,optdipolesize=1]{optdipole}
  \makeatother
\end{pspicture}
...
\testextnodes{elecsynthesizer}{(1,1.6)(3,1.6)}
