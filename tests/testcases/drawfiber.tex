...
\begin{pspicture}[showgrid=true](5,5)
  \psset{unit=1.2}\psrotate(0,0){-45}{\optbox[fiber=i, angle=45, rotateref=bl](0,2)(5,2){}
  \psline(\oenode{}{RotrefA})(\oenode{}{RotrefB})
  \psset{linecolor=orange!90!black}%
  \optbox[fiber=i, rotateref=bl, compshift=0.5, angle=45](0,2)(5,2){}%
  \psline(\oenode{}{RotrefA})(\oenode{}{RotrefB})}
\end{pspicture}
...
%
 ...
 \begin{pspicture}[showgrid=false](10,5)
   \addtopsstyle{Fiber}{fiberangleA=30}
   \pnode(0, 1){A}
   \pnode(5, 1){B}
   \optbox(A)(B){}
   \drawfiber{(A)}{}
...
\newpage
% check drawfiber with ranges
\begingroup
\addtopsstyle{Fiber}{arrows=->, arrowinset=0, arrowscale=1.5}
...
\begin{pspicture}(0,-0.5)(10,2)
  ...
  \optbox(6,0)(8,0)
  \optbox(8,0)(10,0)
  \pscustom[style=Fiber]{\drawfiber[liftpen=2]{1-5}(2,2){Asdf}}
\end{pspicture}
\endgroup
