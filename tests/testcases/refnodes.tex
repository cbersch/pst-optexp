...
\showfdipoleref{optfiber}\hspace{\fill}%
\showfdipoleref{optamp}\hspace{\fill}%
\showfdipoleref{optmzm}%
\bigskip

\noindent\showfdipoleref{optfilter}\hspace{\fill}%
\begin{pspicture}(0,-0.5)(3,1)
  \pnode(0,0.5){A}\pnode(3,0.5){B}
  \polcontrol(A)(B)
...
\showfdipoleref{optisolator}%
\bigskip

\noindent\showfdipoleref{optswitch}\hspace{\fill}%
\showfdipoleref{fiberdelayline}\hspace{\fill}%
\showfdipoleref{optfiberpolarizer}%
\bigskip

\bgroup\psset{beam}
\noindent\showfdipoleref{fibercollimator}\egroup
\bigskip
