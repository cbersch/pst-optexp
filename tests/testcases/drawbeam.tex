...
\begin{pspicture}(5,2)
  ...
  \pnode(4.5,1){B}
  \doveprism(A)(B){}
  \addtopsstyle{Beam}{beamConnectComp, fillstyle=solid, fillcolor=red}
  \drawextendedbeam[beamwidth=0.1]{(A)}{1}{(B)}
\end{pspicture}
...
\begin{pspicture}(5,2)
  ...
  \doveprism(A)(B){}
  \addtopsstyle{Beam}{beamConnectComp, fillstyle=solid, fillcolor=red}
  \drawextendedbeam[beamdiv=3, beamwidth=0.1]{(A)}{1}{(B)}
\end{pspicture}
...
\begin{pspicture}(5,4)
  ...
  \pentaprism(A)(B)(C){}
  \addtopsstyle{Beam}{beamConnectComp, fillstyle=solid, fillcolor=red}
  \drawextendedbeam[beamwidth=0.1]{(A)}{1}{(C)}
\end{pspicture}
\begin{pspicture}(5,4)
  \pnode(0.5,3){A}
  \pnode(3, 3){B}
  ...
  \pentaprism(A)(B)(C){}
  \addtopsstyle{Beam}{beamConnectComp, fillstyle=solid, fillcolor=red}
  \drawextendedbeam[beamdiv=3, beamwidth=0.1]{(A)}{1}{(C)}
\end{pspicture}
...
\begin{pspicture}(5,3)
  ...
  \pnode(5,1){C}
  \optprism(A)(B)(C){}
  \addtopsstyle{Beam}{beamConnectComp, fillstyle=solid, fillcolor=red, opacity=0.2}
  \drawextendedbeam[beamdiv=3, beamwidth=0.1]{(A)}{1}{(C)}
\end{pspicture}
