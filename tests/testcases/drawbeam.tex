...
\begin{pspicture}[showgrid=true](5,3)
  ...
  \multido{\i=0+1}{4}{%
    ...
    \drawbeam[beampos=0 0.6, nproc=1.2 \i\space 0.05 mul sub mul]{(A)}{1}{(B)}
  }%
  \optplane[compname=Plane](5, 1.5)(-1,1)
  \multido{\i=0+1}{4}{%
    \pstVerb{\i\space 650 580 sub 3 div mul 580 add tx@addDict begin wavelengthToRGB end }%
    \drawbeam[beampos=0 -0.6, nproc=1.2 \i\space 0.05 mul sub mul]{(A)}{1}{Plane}
  }%
\end{pspicture}
\end{LTXexample}
\bigskip
...
\begin{pspicture}[showgrid=true](4,3)
  ...
  \multido{\i=0+1}{20}{%
    ...
    \drawbeam[nproc=-0.002 \i\space mul add]{(A)}{1}{(C)}
  }%
\end{pspicture}
\end{LTXexample}
\bigskip
