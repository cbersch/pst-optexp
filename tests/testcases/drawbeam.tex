...
\begin{pspicture}[showgrid=true](6,4)
  ...
  \mirror[mirrorwidth=2](B)(C)(B){} 
  \multido{\r=-0.2+0.2}{3}{%
    \drawbeam[startpos=0 \r]{1}{2}{3}}
\end{pspicture}
\end{LTXexample}
\bigskip

\subsubsection{startpos and beamangle}
...
\begin{pspicture}(5,2)
  ...
  \drawbeam[linecolor=red, startpos=0 -0.1]{(A)}{1}{(B)}
...
\begin{pspicture}(5,2)
  ...
  \doveprism(A)(B){}
  \addtopsstyle{Beam}{connectplanes}
  \drawbeam[linecolor=red, startpos=0 -0.1, beamangle=-2.3]{(A)}{1}{(B)}
  \drawbeam[linecolor=black]{(A)}{1}{(B)}
  \drawbeam[startpos=0 0.1, beamangle=2.3]{(A)}{1}{(B)}
\end{pspicture}
