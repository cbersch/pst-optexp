...
\begin{pspicture}(13.6,1.6)
  \psset[optexp]{labeloffset=1, mirrorwidth=0.5, optboxwidth=2}
  \pnode(2,0){Laser}\pnode(12,1){Film}\pnode(Film|Laser){Ref}
  \begin{optexp}
    ...
    \mirror[label=1 30]([offset=0.2]Laser)([offset=0.2]Ref)(Film){\begin{tabular}{l}Spiegel\\(fest)\end{tabular}}
