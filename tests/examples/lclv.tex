...
\makeatletter
\def\LCLV@nodes{%
  \newOptexpComp{ {-0.12 0} {0 1} 0 0 trans {PlaneIfc}
                  {0.15 0} {0 1} 0 0 trans {PlaneIfc} \POE@key@n}%
}%
\def\LCLV@comp{%
...
\drawbeam[raytrace=false]{LCLV}{BS}{3-9}{Dove}{11}{LCLV}
\end{pspicture}
\vspace{1cm}
%\end{document}
...
\lens(BS2)(BS1){L}
\optbox[labeloffset=0, endbox](BS1)([Xnodesep=-1]BS1){Nd:YAG}
\addtopsstyle{Beam}{raytrace=false, beamwidth=0.3, fillstyle=solid, opacity=0.3, fillcolor=green, linestyle=none}
\psset{loadbeampoints}
\drawwidebeam{LCLV}{BS}{3-5}
\drawwidebeam[beamdiv=-5.1]{5-7}
\drawwidebeam{7-9}{Dove}{11}
