...
%% Author: cbersch
%% Version: $Id: testt.tex,v 0.0 2011/04/14 10:20:40 Exp$
...
\lens(BS2)(BS1){L}
\optbox[labeloffset=0, endbox](BS1)([Xnodesep=-1]BS1){Nd:YAG}
\addtopsstyle{Beam}{beamConnectComp, beamwidth=0.3, fillstyle=solid, opacity=0.3, fillcolor=green, linestyle=none}%width=0.4\pslinewidth}
\custombeam{%
  \drawextendedbeam{LCLV}{BS}{3}{4}{5}
  \drawextendedbeam[beamdiv=-5.1]{5}{6}{7}
  \drawextendedbeam{7}{8}{9}{Dove}{11}
  \drawextendedbeam[beamdiv=10]{11}{LCLV}
}
\end{optexp}
\end{pspicture}
...
\drawextendedbeam{LCLV}{BS}{3}{4}{5}{6}{7}{8}{9}{Dove}{11}{LCLV}
\drawextendedbeam[beaminsidelast]{([Xnodesep=-1]BS1)}{BS}
\drawbeam[addtoBeam={beaminsidelast, arrows=->, linewidth=3\pslinewidth, arrowinset=0}]{([Xnodesep=-1]BS1)}{BS}
\drawextendedbeam[addtoBeam={beaminsidefirst}]{9}{([offset=-1]BS2)}
...
\drawextendedbeam[n=1.72]{LCLV}{BS}{3}{4}{5}{6}{7}{8}{9}{Dove}{11}{LCLV}
\end{optexp}
\end{pspicture}
\end{document}
