...
\begin{pspicture}(12.5,9)
  ...
  \pinhole[phwidth=0.07, outerheight=0.6, abspos=1.4, labelangle=10](L)(PSLM){PH}
  ...
  \drawwidebeam[savebeampoints=2, stopinside]{9-11}
  \drawwidebeam[loadbeampoints=2, beamdiv=-17, beamangle=5, stopinside]{11-12}
  \drawwidebeam[beamangle=-5]{12-16}
  \drawwidebeam[loadbeampoints=2, beamdiv=-17, beamangle=-5, stopinside]{11-12}
  \drawwidebeam[beamangle=5]{12-16}
  %
  \lens[lens=0.5 0.5 0.4, n=2](L|MRef)(MRef){MO}
  \pinhole[phwidth=0.07, outerheight=0.6, position=0.52, labelangle=180](L|MRef)(MRef){PH}
  \lens[position=0.65](L|MRef)(MRef){L}
  \optplate[position=0.7](L|MRef)(MRef){S}
  \mirror(L|MRef)(MRef)(MRef|Cam)
  \addtopsstyle{Beam}{fillcolor=red!70}
  \drawwidebeam[loadbeampoints=false, beamwidth=0.1, savebeampoints]{2}{17-19}
  \drawwidebeam{19-21}{14-16}
\end{optexp}
\end{pspicture}
\end{document}
