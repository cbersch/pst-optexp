...
\begin{pspicture}[showgrid](-2,0)(8.3,5.9)
  ...
  \drawwidebeam{Et}{5-8}\backlayer{\pnode(\oenodeBeamUp{}){BeamA}}
  ...
  \drawwidebeam[loadbeam]{11}{9}\backlayer{\pnode(\oenodeBeamUp{}){BeamD}}
  \drawwidebeam[loadbeam]{9}{12-13}
  ...
  \nlput[nrot=:U](BeamA)(BeamB){1}{%
    ...
    \rput(0,0.1){\psset{unit=0.7}\mypulse\rput(0.8,0){\mypulse}}}%
  \psline[linecolor=green](BeamD)(BeamC)
