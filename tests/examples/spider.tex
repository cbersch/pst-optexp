...
\begin{pspicture}(-2,0)(8.3,5.9)
  ...
  \begin{optexp}
  \mirror[mirrortype=semitrans, mirrorlinewidth=0.7\pslinewidth, label=0.6 -90](In)([Xnodesep=-3]G1)(M1){Etalon}
  ...
  \rput([Xnodesep=0.3,offset=0.1]In){%
    \psplot[style=Pulse]{-0.3}{0.3}{2.7182818 x 0.1 div 2 exp neg exp 0.8 mul}
    \psline[arrows=->, style=Arrow](0,-0.4)(1,-0.4)}
  \rput([Xnodesep=1.5,offset=-0.3]\oenodeCenter{1}){\psline[arrows=<->, style=Arrow](-0.7,0)(0.7,0)}
\end{pspicture}
\end{document}
