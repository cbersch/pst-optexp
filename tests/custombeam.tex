...
\begin{pspicture}[showgrid=true](4,5)
  ...
  \lens[n=1.3, abspos=2, labelangle=180](A)(G){L}
  \pentaprism[n=1, labeloffset=1](A)(G)(B){PP}
  \lens[abspos=1](G)(B){L}
  ...
  \custombeam{%
    \drawbeam[nMul=2, beaminsidelast]{1}{2}{4}.
    \drawbeam[n=1,stopInside=false, beaminsidelast=false]{4}{5}{6}.
    \drawbeam{6}{7}{8}.
    \drawbeam[beaminsidefirst, n=1]{8}{9}.
  }
  \end{optexp}
\end{pspicture}
\end{document}
