...
\begin{pspicture}(3.2,5)
  ...
  \begin{optexp}
    \beamsplitter[compname=BS](In)(BS)(PD)
    \mirror[compname=M1](BS)(M1)(BS)
    \mirror[compname=M2, variable](BS)(M2)(BS)
    \lens[compname=L](BS)(PD)
    \optdetector[compname=Det](BS)(PD)
    \addtopsstyle{Beam}{beamwidth=0.2, fillstyle=solid, fillcolor=green!20!white}
    \drawwidebeam{(In)}{BS}{M1}{BS}{M2}{BS}{L}{Det}
    \drawbeam[linecolor=red, beamangle=1.5]{(In)}{BS}{M1}{BS}{M2}{BS}{L}{Det}
  \end{optexp}
\end{pspicture}
\end{document}
