...
\makeatletter
\providecommand\ON{%
  \gdef\lst@alloverstyle##1{\textcolor{black!30}{\strut##1}%
}}
...
*\ON*\begin{pspicture}[showgrid](5,2)
  \pnode(0,1){In}\pnode(3.5,1){Out}\psdot(In)\psdot(Out)*\OFF*
  \lens[lensradius=-0.7, abspos=1](In)(Out){concave}
...
\begin{LTXexample}
*\ON*\begin{pspicture}[showgrid](5,2)
  \pnode(0,1){In}\pnode(3.5,1){Out}\psdot(In)\psdot(Out)
  \lens[lensradius=-0.7, abspos=1](In)(Out){concave}*\OFF*
...
*\ON*\begin{pspicture}[showgrid](5,2)
  \pnode(0,1){In}\pnode(3.5,1){Out}\psdot(In)\psdot(Out)
  \lens[lensradius=-0.7, abspos=1](In)(Out){concave}
  \lens[lensradius=2.3, lensheight=1.3, abspos=2.6](In)(Out){convex}*\OFF*
