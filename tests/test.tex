...
%% Author: cbersch
%% Version: $Id: test.tex,v 0.0 2011/07/18 21:59:24 Exp$
...
\begin{document}
\begin{pspicture}[showgrid=true](-4,-1)(3,3)
...
\begin{optexp}
  ...
  \optretplate[position=0.3,labeloffset=0.8](LaserOut)(Grat){$\frac{\lambda}{4}$}
