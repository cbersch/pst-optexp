...
\newpsstyle{Refline}{linecolor=gray!60}
\begin{document}
\psset{pswarning=true}
\begin{pspicture}[showgrid](0,-0.3)(3,2.3)
  \pnode(1.5,1){A}\pnode(3,1){B}
  \lens[n=1.1, lensheight=1.5](A)(B)
  \drawbeam[beaminsidefirst]{1}
\end{pspicture}
\end{document}
...
\begin{optexp}
  ...
  \optdipole[position=0.2, compname=LCLV, optdipolesize=0.27 1, optdipoleoffset=0.015 0](BS1)(BS2){%
...
\begin{pspicture}[showgrid](5,2)
  \optbox(0,1)(5,1)
  \drawwidebeam[fillstyle=solid, fillcolor=red, linestyle=none,ArrowInside=->, beamwidth=0.3](0,1){}(5,1)
  \drawbeam[linestyle=none, arrowscale=1.5,ArrowInside=->>](0,1){}(5,1)
\end{pspicture}
\end{document}
\begin{pspicture}(3,2)
  \optretplate[platesize=0.2 1](0,1)(3,1)
  \drawbeam[beaminside=false](0,1){}(3,1)
\end{pspicture}
\begin{pspicture}[showgrid](2,2)
  \optdetector[fillstyle=solid, fillcolor=blue, arrows=<->](0,1)(1,1)
\end{pspicture}
\end{document}
\begin{pspicture}[showgrid](10,3)
  \pnode(0,1){A}\pnode(10,1){B}
  \optbox[position=0.3](A)(B)
  \optbox[position=0.7](A)(B)
  \drawbeam[beaminside=false](A){-}(B)
  \drawfiber([offset=0.5]A){1}{2}([offset=0.5]B)
\end{pspicture}
\end{document}
...
%  \drawbeam[loadbeam, linecolor=blue]{2-3}
  \drawbeam[loadbeam, startinside, linecolor=red]{2-3}
\end{pspicture*}
\end{document}
\begin{pspicture}(4,2)
  \psset{fiber=*}
...
\begin{pspicture}(3,2)
  ...
  \optcirculator[fiber=t](0,0.5)(1.5,0)(3,2)
...
\begin{pspicture}(0,-0.8)(7,0.8)
  ...
  \drawfiber[fiberalign=abs]{(A)}{1}{2}{(D)}
\end{pspicture}

\begin{pspicture}(-1,0)(7,2.4)
  \optbox[fiber, angle=30](0,1)(4,1)
...
\begin{pspicture}(-1,0)(7,2.4)
  \optbox[fiber=l, angle=30](0,1)(3,1)
  \psdot(\oenodeRefA{})
  \psline[style=Refline, linestyle=dashed](\oenodeTrefA{})(\oenodeTrefB{})
  \optbox[angle=-30, fiber=r](4,1)(7,1)
  \psdot(\oenodeRefB{})
  \psline[style=Refline, linestyle=dashed](\oenodeTrefA{})(\oenodeTrefB{})
  \drawfiber{1}{2}
\end{pspicture}

\begin{pspicture*}[showgrid](0,2)(3.05,6)
  \optplane(0,2)
  ...
  \drawbeam[loadbeam, startinside]{2-3}
\end{pspicture*}
...
\begin{pspicture}[showgrid](0.3,0.1)(4.8,1.6)
  ...
  \psdot[linecolor=red](\oenodeOut{})\uput[80](\oenodeOut{}){\rput[l](0,0.1){Out}}
  \psdot(\oenodeIn{})\uput[90](\oenodeIn{}){In}
...
\begin{pspicture}(1,1.2)(6.2,5)\psset{extnodealign=rel}
...
\begin{optexp}
  ...
  \optdetector[compname=Det1, extnode=r](BS)(Det1){PD1}\psdot(\oenodeExt{})
  \optdetector[compname=Det2, extnode=r](BS)(Det2){PD2}\psdot(\oenodeExt{})
...
\optbox[showoptdots, position=start, compname=L, extnode=b](Lin)(Det){%
...
\begin{pspicture}[showgrid](5,5)
  \optmzm(0,1)(5,1)
  \optmzm[optmzmsize=1 0.8](0,2.5)(5,2.5)
  \optmzm[optmzmsize=1 0.6](0,4)(5,4)
\end{pspicture}

\begin{pspicture}[showgrid](3,2)
  \optdetector[detsize=1 0.6](0,2)(1,2)
  \optdetector(0,1)(1,1)  
\end{pspicture}
\begin{pspicture}[showgrid](3,2)
  \psset{dettype=diode}
...
\begin{pspicture}[showgrid](5,5)
  \optisolator[isolatorsize=2 0.5](0,0.5)(5,0.5)
  \psset[optexp]{isolatorsize=1}
  \optisolator(0,2)(5,2)
  \optisolator[isolatorsize=. 0.4](0,3.5)(5,3.5)
\end{pspicture}
...
\begin{pspicture}(0.5,0)(2.2,4)
  ...
  \addtopsstyle{Beam}{linestyle=none, beamwidth=0.2, fillstyle=solid}%, beaminsidelast}
...
\begin{pspicture}(5,2)
  ...
  \doveprism(A)(B){}
  \addtopsstyle{Beam}{raytrace=false}
  \drawwidebeam[beamwidth=0.2, beamdiv=4.6]{(A)}{1}{(B)}
\end{pspicture}

\begin{pspicture}[showgrid](4,2.5)
...
\pnode([Xnodesep=5.5]M1){PP}\pnode(PP|BS1){BS2}
\begin{optexp}
  \optbox[labeloffset=0, endbox, optboxwidth=1.6](BS1)([Xnodesep=-1]BS1){Nd:YAG}
  \beamsplitter[compname=BS](BS2)(BS1)(M1){BS}
...
\begin{pspicture}(3,2)
  ...
  \drawbeam[n=1, linecolor=green]{(A)}{}{(C)}
%  \drawbeam[n=1.5, linecolor=blue]{(A)}{}{(C)}
...
\begin{pspicture}(3,3)
  ...
  \psset{fiber=none, optboxsize=1 0.6, label=0 . . relative}
...
\begin{pspicture}[showgrid](4,2)
  ...
  \drawfiber[fiberangleA=20, fiberangleB=-20]{1}{2}
\end{pspicture}
...
\psdot(\oenodeRefA{})\uput[90](\oenodeRefA{}){RefA}
\psdot(\oenodeRefB{})\uput[90](\oenodeRefB{}){RefB}
\optcoupler[coupleralign=top](4, 2)(4,0.7)(7,2)(7,0.7)
\psdot(\oenodeRefA{})\uput[-90](\oenodeRefA{}){RefA}
\psdot(\oenodeRefB{})\uput[-90](\oenodeRefB{}){RefB}
\optcoupler[coupleralign=bottom](8, 2)(8,0.7)(11,2)(11,0.7)
\psdot(\oenodeRefA{})\uput[90](\oenodeRefA{}){RefA}
\psdot(\oenodeRefB{})\uput[90](\oenodeRefB{}){RefB}
...
\begin{pspicture}[showgrid](5,5)
  ...
  \newpsstyle{CrystalLamp}{unit=0.7}
  \crystal[lamp](0,3)(5,3)
\end{pspicture}
...
\begin{pspicture}[showgrid](-0.2,0.1)(8.2,5.3)
  ...
  \multido{\i=0+1}{40}{%
    ...
    \drawbeam[n=n -0.002 \i\space mul add, beaminsidelast]{(In)}{3-5}{2}{1}{6-7}
  }%
  ...
  \drawbeam[linewidth=2\pslinewidth, arrows=->, arrowinset=0, beamangle=-90, beamalign=absolute]{(\oenodeBeam{})}{8}{(Out)}  
\end{optexp}
\rput(4,4.5){%
