...
\def\psoe@cs@out@{}%
\def\psoe@cs@in@{}%
\def\psoe@cs@in@o{\psline[style=Beam](\optexp@refnodeA)(\optexp@nodeA)}%
\def\psoe@cs@out@o{\psline[style=Beam](\optexp@nodeB)(\optexp@refnodeB)}%
\def\psoe@cs@in@f{%
   \pccurve[angleA=!\pst@optexpdict /N@\optexp@refnodeB\space /N@\optexp@refnodeA\space FiberAngleA end, 
            angleB=!\pst@optexpdict /N@\optexp@refnodeB\space /N@\optexp@refnodeA\space FiberAngleB end, 
            style=FiberIn](\optexp@refnodeA)(\optexp@nodeA)%
}%
\def\psoe@cs@out@f{%
   \pccurve[angleA=!\pst@optexpdict /N@\optexp@refnodeB\space /N@\optexp@refnodeA\space FiberAngleA end, 
            angleB=!\pst@optexpdict /N@\optexp@refnodeB\space /N@\optexp@refnodeA\space FiberAngleB end, 
            style=FiberOut](\optexp@nodeB)(\optexp@refnodeB)%
}%
\def\psoe@cs@in@i{%
