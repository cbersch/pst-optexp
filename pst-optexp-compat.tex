...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\def\optexp@nodeA{\POK@b@sicname 1}%
\def\optexp@nodeB{\POK@b@sicname N}%
...
\def\drawbeam@i#1#2{%
   ...
   \else
      ...
      \edef\POK@b@sicnameB{#2\POS@basicname@postfix}%
   \fi
   \if(\pst@tempA
   ...
   \else
      ...
      \edef\POK@b@sicnameA{#1\POS@basicname@postfix}%
   \fi
